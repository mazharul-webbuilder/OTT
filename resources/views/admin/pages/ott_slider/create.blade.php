        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-10 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Ott Slider</h4>  
                             @include('admin.includes.errors') 
                            <form method="POST" action="{{ route('ott-slider.store') }}" enctype="multipart/form-data">
                                @csrf

                                <div class="mb-3">
                                    <label for="formrow-firstname-input" class="form-label">Title</label>
                                    <input type="text" class="form-control slug-input" id="formrow-firstname-input-title" value="{{ old('title')}}" name="title">
                                </div>

                                <div class="mb-3">
                                    <label for="formrow-firstname-input" class="form-label">Slug</label>
                                    <input type="text" class="form-control slug-output" id="formrow-firstname-input-slug" name="slug">
                                </div>
                                ...
                                <div class="row">  
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control slug-input"  value="{{ old('bottom_title')}}" name="bottom_title">
                                        </div>
                                    </div>
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control slug-input"  value="{{ old('content_url')}}" name="content_url">
                                        </div>
                                    </div>
