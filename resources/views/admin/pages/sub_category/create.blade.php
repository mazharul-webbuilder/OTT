        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Sub Category Create</h4>
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control slug-input"   value="{{ old('seo_title')}}" name="seo_title">
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-warning mdi mdi-book-edit-outline"
                                                                href="{{ route('sub-category.show', $item->id) }}"></a>
            ...
            $('.delete').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/admin/sub-category-delete/' + data, 
