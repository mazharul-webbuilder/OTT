        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-4">Ott Series Create</h4>
                            @include('admin.includes.errors')
                            <form method="POST" action="{{ route('ott-series.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Ott Series</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($item->status == 'Published')
                                                                <span
                                                                    class="badge badge-pill badge-soft-success font-size-12">{{ $item->status }}</span>
                                                            @else
                                                                <span
                                                                    class="badge badge-pill badge-soft-danger font-size-12">{{ $item->status }}</span>
                                                            @endif
                                                        <td>
                                                            <a class="btn btn-warning mdi mdi-book-edit-outline"
                                                                href="{{ route('ott-series.show', $item->id) }}"></a>
            ...
            $('.delete').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/admin/ott-series-delete/' + data,
                    ...
                    success: function(response) {
                        ...
                        $.each(response.sub_sub_categories, function(index, sub_sub_category) {
                            $('#sub_sub_category_id').append('<option value="' +
                                sub_sub_category.id + '">' + sub_sub_category
                                .title +
                                '</option>');
                        })
                    }
