                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('sub-sub-category.update', $data->id) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="root_category_id" id="root_category_id">
                                                ...
                                                @foreach ($root_categories as $item)
                                                    <option @if ($item->id == $data->root_category_id) selected @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="sub_category_id" id="sub_category_id">
                                                @foreach ($selected_sub_categories as $item)
                                                    <option @if ($item->id == $data->sub_category_item) selected @endif
                                                        value="{{ $item->id }}">{{ $item->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="status">
                                                ...
                                                @foreach (config('constants.CATEGORYSTATUS') as $item)
                                                    <option @if ($item == $data->status) selected @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control slug-input"
                                                value="{{ $data->seo_title }}" name="seo_title">
                                        </div>
                                    </div>
