    ...
    Dropzone = (function() {
        ...
        function b(e, t) {
            ...
            return (
                ...
                i.parentNode &&
                i.parentNode.removeChild(i), !1 !== n.options.previewsContainer &&
                        ...
                        value: function(s) {
                            ...
                            this._transformFiles(s, function(e) {
                                ...
                                if (s[0].upload.chunked) {
                                    ...
                                    var i = function() {
                                        for (
                                            var e = 0; void 0 !== r.upload.chunks[e];
                                    ...
                                    if (
                                        ...
                                        for (
                                            var n = 0; n < r.upload.totalChunkCount; n++
                                        )
                                            i();
                                    else i();
                                } else {
                        ...
                        value: function(e, t, n) {
                            ...
                            if (void 0 !== n) {
                                if (
                                    ...
                                    (r.upload.total = 0);
                                    for (
                                        var a = (r.upload.bytesSent = 0); a < r.upload.totalChunkCount; a++
                                    )
...
var detectVerticalSquash = function(e) {
        ...
        i.drawImage(e, 0, 0);
        for (
            var r = i.getImageData(1, 0, 1, t).data, o = 0, a = t, l = t; o < l;
...
var contentLoaded = function(t, n) {
    function i(e) {
        if ("readystatechange" !== e.type || "complete" === o.readyState)
            return (
                ("load" === e.type ? t : o)[s](u + e.type, i, !1), !r && (r = !0) ? n.call(t, e.type || e) : void 0
            );
    }
    var r = !1,
        e = !0,
